...
export default function ServicesPage() {
  ...
  const [waitingOrderData, setWaitingOrderData] = useState<WaitingOrderData | null>(null)
  ...
  useEffect(() => {
    const savedWaitingOrder = localStorage.getItem("waitingOrderData")
    if (savedWaitingOrder) {
      setWaitingOrderData(JSON.parse(savedWaitingOrder))
    }
  }, [])
  ...
  const handleOrderComplete = () => {
    localStorage.removeItem("waitingOrderData")
    setWaitingOrderData(null)
  }
    ...
    return (
      <div className="flex justify-center items-center min-h-screen">
        <div className="text-center p-4">
          ...
          <button onClick={fetchServices} className="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700">
            Try Again
          </button>
        </div>
      </div>
    ...
    <div className="flex min-h-screen">
      ...
      <div className="flex-1 ml-64 p-8">
        <h1 className="text-3xl font-bold mb-8">
          {selectedCategory === "ALL" ? "All Services" : formatCategory(selectedCategory)}
        </h1>
